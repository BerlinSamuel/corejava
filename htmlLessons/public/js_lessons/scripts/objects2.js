...
myobject.data = 100;                     // calling set data()
...
// So the getter method for the data property can refer to the x property like this. x.
...
var serialnum = {
	...
	$n: 0,       // it like a private variable
...
class RegisterNumber {
  #number;                     // Private field # is legal inside javascript class but illegal in javascript object
  constructor() {  
    this.#number = 1;
  }
  getNumber(){ return this.#number;}
  #printToScreen(){ return this.#number;}    // Private field -  proper private field
  callPrint(){
	const x=this.#printToScreen();               // Call the private method or function within the same class
	return x;
	}
}
...
console.log(`Private  Number ${rn.callPrint()}`);
 ...
 //console.log(`Next Number ${rn.#printToScreen()}`);          // illegal calling from outside class
var p = {
  // An ordinary data property
  data_y: 0,
  // An accessor property defined as a pair of functions
